...
<template>
  <div class="content">
    ...
    <div class="content-left">
      <!-- 房型分类 -->
      <div class="left-search-item" style="display: flex; height: 100%;">
        <!-- 房型分类标题 -->
        <!-- 房型分类树形结构 -->
    ...
    <div class="content-right">
      ...
      <a-spin :spinning="contentData.loading" style="min-height: 200px;">
        ...
        <div class="pc-thing-list flex-view">
          ...
          <div v-for="item in contentData.pageData" :key="item.id" @click="handleDetail(item)" class="thing-item item-column-3">
            ...
            <div class="info-view">
              ...
              <span class="a-price">{{ item.price }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  ...
                  <button v-if="1" class="buy-btn" @click="handleOrder(detailData)">
                  <img :src="AddIcon" />
                  <span>立即预订</span>
                </button>
          ...
          <!-- 无数据提示 -->
          <div v-if="contentData.pageData.length <= 0 && !contentData.loading" class="no-data" style="">抱歉！没有此类房间</div>
        </div>
      </a-spin>

      <!-- 分页视图 -->
      <div class="page-view" style="">
        <a-pagination v-model="contentData.page" size="small" @change="changePage" :hideOnSinglePage="true" :defaultPageSize="contentData.pageSize" :total="contentData.total" :showSizeChanger="false" />
      </div>
    </div>
  </div>
...
//这是一个处理 a-tree 组件的选择事件 onSelect 的函数。
