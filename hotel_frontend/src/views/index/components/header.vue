...
<template>
  <div class="main-bar-view">
    <div class="logo">
      ...
      &nbsp;&nbsp;<a href="/"
        style="font-size: large;font-weight:bolder;color: white;">学人馆 前台预定系统</a>
    </div>
      ...
      <template v-if="userStore.user_token">
        <a-dropdown>
          <a class="ant-dropdown-link" @click="e => e.preventDefault()">
            <img v-if="userData.form.avatar" :src="userData.form.avatar" class="self-img">
...
import logoImage from '/@/assets/images/sysu.png';
