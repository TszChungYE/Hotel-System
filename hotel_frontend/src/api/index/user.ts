...
enum URL {
    userLogin = '/hotel/index/user/login',
    userRegister = '/hotel/index/user/register',
    detail = '/hotel/index/user/info',
    updateUserPwd = '/hotel/index/user/updatePwd',
    updateUserInfo = '/hotel/index/user/update'
}
interface LoginRes {
    token: string;
}
